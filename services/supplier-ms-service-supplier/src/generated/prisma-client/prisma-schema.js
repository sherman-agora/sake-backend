...
/* GraphQL */ `type AggregateSupplier {
  count: Int!
}
...
input SupplierWhereInput {
  ...
  paymentTerms: String
  paymentTerms_not: String
  paymentTerms_in: [String!]
  paymentTerms_not_in: [String!]
  paymentTerms_lt: String
  paymentTerms_lte: String
  paymentTerms_gt: String
  paymentTerms_gte: String
  paymentTerms_contains: String
  paymentTerms_not_contains: String
  paymentTerms_starts_with: String
  paymentTerms_not_starts_with: String
  paymentTerms_ends_with: String
  paymentTerms_not_ends_with: String
  creditLine: String
